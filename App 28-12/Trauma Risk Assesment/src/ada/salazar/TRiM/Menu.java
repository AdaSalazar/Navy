	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    //The "final" allows to use the var in submethods	 the context "This" is just to use it in the instance of this object
		 ...
		 bTRM.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent("ada.salazar.TRiM.bIntentTRM"));//This is NOT needed for the rest of the buttons
			}
		});
		...
		bBH.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//This goes to the new layout 
				startActivity(new Intent("ada.salazar.TRiM.bIntentBH"));//This is NOT needed for the rest of the buttons
		...
		bTR.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//This goes to the new layout 
				startActivity(new Intent("ada.salazar.TRiM.bIntentTR"));//This is NOT needed for the rest of the buttons
