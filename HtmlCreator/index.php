...
$body = '
	...
	for ($i=1; $i<=$paragraphNumber; $i++){
		$body= $body.'
					<a name= "chapter'.$i.'"></a> 
					<a href= "webpage.html#chapter1">'.$h1Name.'</a><br>';
	}				
		//the str_replace will replace the spaces for underscore and change the bookTitle to lowercase			
$body= $body.'	</td>
				<td>
					Book Cover  <br> 
					<img src="images/'.str_replace(strtolower($bookTitle), " ", "_").'.png" alt="BookCover" width="25%">
	...
	$pName='p'.$i;
		...
		<p>'.$_POST[$pName].'</p><br />
							...
							<p align="right"><a href="#chapter'.$i.'">Index</a></p>
